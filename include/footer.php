...
<footer class="ftco-footer ftco-bg-dark ftco-section img" style="background-image: url(images/bg_2.jpg); background-attachment:fixed;">
        ...
        <div class="row mb-5">
          <div class="col-md-3">
            <div class="ftco-footer-widget mb-4">
              <h2><a class="navbar-brand" href="index.html"><i class="flaticon-university"></i>Peru Suizo <br><small>Cetpro</small></a></h2>
          ...
          <div class="col-md-4">
            <div class="ftco-footer-widget mb-4">
              ...
              <div class="block-21 mb-4 d-flex">
                ...
                <div class="text">
                  <h3 class="heading"><a href="#">Evento numero 1</a></h3>
                  <div class="meta">
                    <div><a href="#"><span class="icon-calendar"></span> Julio 29, 2024 </a></div>
              ...
              <div class="block-21 mb-4 d-flex">
                ...
                <div class="text">
                  <h3 class="heading"><a href="#">Evento numero 2</a></h3>
                  <div class="meta">
                    <div><a href="#"><span class="icon-calendar"></span> Julio 12, 2024</a></div>
                    <div><a href="#"><span class="icon-person"></span> Administrador</a></div>
                    <div><a href="#"><span class="icon-chat"></span> 19</a></div>
                  </div>
                </div>
          ...
          <div class="col-md-2">
             <div class="ftco-footer-widget mb-4 ml-md-4">
              <h2 class="ftco-heading-2">Enlaces a sitios</h2>
              <ul class="list-unstyled">
                <li><a href="index.php" class="py-2 d-block">Inicio</a></li>
                <li><a href="sobre_nosotros.php" class="py-2 d-block">Sobre Nosotros</a></li>
                <li><a href="cursos.php" class="py-2 d-block">Cursos</a></li>
                <li><a href="#" class="py-2 d-block">Estudiantes</a></li>
  ...
  Copyright &copy;<script>document.write(new Date().getFullYear());</script> Raul | Ñaupari Araujo <i class="icon-heart" aria-hidden="true"></i>  <a href="#" target="_blank">Raul Jr</a>
