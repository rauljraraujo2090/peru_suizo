        ...
        <div id="preloader" class="preloader">
            <div class="animation-preloader">
                ...
                <div class="txt-loading">
                    ...
                    <span data-text-preloader="N" class="letters-loading">A
                </span>
                    <span data-text-preloader="F" class="letters-loading">U
                </span>
                    <span data-text-preloader="O" class="letters-loading">L
                </span>
                    <span data-text-preloader="T" class="letters-loading">
                </span>
                    <span data-text-preloader="E" class="letters-loading">J
                </span>
                    <span data-text-preloader="K" class="letters-loading">R
                </span>
                </div>
            ...
            <div class="offcanvas__info">
                <div class="offcanvas__wrapper">
                    <div class="offcanvas__content">
                        ...
                        <p class="text d-none d-lg-block">Nullam dignissim, ante scelerisque the  is euismod fermentum odio sem semper the is erat, a feugiat leo urna eget eros. Duis Aenean a imperdiet risus.
                        </p>
                                ...
                                <li class="d-flex align-items-center">
                                    ...
                                    <div class="offcanvas__contact-text">
                                        <a href="mailto:info@azent.com">
                                            <span class="mailto:info@example.com">info@example.com</span>
                                        </a>
                                    </div>
                                </li>
                                <li class="d-flex align-items-center">
                        ...
                        <div class="col-lg-6 mt-4 mt-lg-0">
                            <div class="about-content">
                                <div class="section-title">
                                    <span class="wow fadeInUp">Sobre Raul Jr</span>
                                    <h2 class="wow fadeInUp" data-wow-delay=".3s">
                                       Estamos aumentando  el Éxito  en la teconología y la   <span>programación</span>
                                    </h2>
                                </div>
                                <p class="mt-3 mt-md-0 wow fadeInUp" data-wow-delay=".5s">
                                Es un hecho establecido desde hace mucho tiempo que un lector se distraerá con el
 <br>contenido legible de una página cuando mire el diseño del punto.
                                ...
                                <div class="about-icon-items">
                                    ...
                                    <div class="icon-items wow fadeInUp" data-wow-delay=".9s">
                                        ...
                                        <div class="content">
                                            ...
                                            <p>Ut vehiculadictumst. Maecenas ante.
                                            </p>
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="marque-section-3 section-padding">
                    ...
                    <div class="marquee-inner to-left">
                        <ul class="marqee-list d-flex">
                            <li class="marquee-item style-2">
                                ...
                                <span class="text-slider text-style">Cyber Security</span>
                                <span class="text-slider">
                                    <img src="assets/img/asterisk.svg" alt="img">
                                </span>
                                <span class="text-slider text-style">IT Solution</span>
                                <span class="text-slider">
                                    <img src="assets/img/asterisk.svg" alt="img">
                                </span>
                                <span class="text-slider text-style">Technology</span>
                                <span class="text-slider">
                                    <img src="assets/img/asterisk.svg" alt="img">
                                </span>
                                <span class="text-slider text-style">Data Security</span>
                                <span class="text-slider">
                                    <img src="assets/img/asterisk.svg" alt="img">
                                </span>
                                <span class="text-slider text-style">Cyber Security</span>
        ...
        <!--<< Team Section Start >>-->
        <section class="team-section-3 fix pt-0 section-padding">
            <div class="container">
                <div class="section-title-area">
                    <div class="section-title">
