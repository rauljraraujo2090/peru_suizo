        ...
        <div class="row">
          <div class="col-xl-7 col-xxl-8">
            ...
            <div class="d-none d-xl-flex align-items-center justify-content-center h-n80">
              <img src="goku.png" alt="modernize-img" class="img-fluid" width="500">
            </div>
          </div>
          <div class="col-xl-5 col-xxl-4">
            <div class="authentication-login min-vh-100 bg-body row justify-content-center align-items-center p-4">
              <div class="auth-max-width col-sm-8 col-md-6 col-xl-7 px-4">
                <h2 class="mb-1 fs-7 fw-bolder">Bienvenido a Calcular</h2>
                ...
                <form  action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                  <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label">PESO PROMEDIO GRAMOS</label>
                    <input type="number" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="num1" value="<?php echo $numero12?>">
                  </div>
                  <div class="mb-4">
                    <label for="exampleInputPassword1" class="form-label">CANTIDAD DE PECES</label>
                    <input type="number" class="form-control" id="exampleInputPassword1" name="num2" value="<?php echo $numero2?>">
                  </div>
                  ...
                  <div class="col-6">
                    <a class="btn text-dark border fw-normal d-flex align-items-center justify-content-center rounded-2 py-8" href="javascript:void(0)" role="button">
                      <img src="../assets/images/svgs/facebook-icon.svg" alt="modernize-img" class="img-fluid me-2" width="18" height="18">
                      <input type="text" aria-label="Disabled input example" disabled readonly   class="form-control"autocomplete="off"  value="<?php echo $resultado?>"id="exampleInputPassword1">
                     
                    </a>
                    <label for="exampleInputEmail1" class="form-label">Biomasa KG</label>
                  </div>
                  <div class="col-6">
                    <a class="btn text-dark border fw-normal d-flex align-items-center justify-content-center rounded-2 py-8" href="javascript:void(0)" role="button">
                      <img src="../assets/images/svgs/facebook-icon.svg" alt="modernize-img" class="img-fluid me-2" width="18" height="18">
                      <input type="text"aria-label="Disabled input example" disabled readonly   class="form-control"value="<?php echo $sumarr?>" autocomplete="off" id="exampleInputPassword1">
                     
                    </a>
                    <label for="exampleInputEmail1" class="form-label">Ración Alimentaria </label>
                  </div>
                </div>
                  ...
                  <button class="btn btn-primary w-100 py-8 mb-4 rounded-2">Calcular Resultado</button>
                ...
                <button type="reset" class="btn btn-primary w-100 py-8 mb-4 rounded-2">Limpiar Resultado</button>
              </div>
            </div>
          </div>
        </div>
