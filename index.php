    				...
    				<div class="courseSearch-wrap d-md-flex flex-column-reverse">
    					<div class="full-wrap d-flex ftco-animate">
    						<div class="one-third order-last p-5">
    							<span>¿Sabes lo que buscas?</span>
    							<h3>Quiero estudiar</h3>
    							<form action="#" class="course-search-form">
		                
		              </form>
		              <p>¿Solo navegando?<a href="cursos_copy.php"> Ver todos los cursos</a></p>
    						</div>
    	...
    	<div class="container">
          ...
          <div class="col-md-4 d-flex align-self-stretch ftco-animate">
            <div class="media block-6 services p-3 py-4 d-block text-center">
              ...
              <div class="media-body px-3">
                <h3 class="heading">Admision</h3>
                <p>Incluso el todopoderoso Señalamiento no tiene control sobre los textos ciegos, es un texto casi poco ortográfico.</p>
              </div>
            </div>      
          </div>
          <div class="col-md-4 d-flex align-self-stretch ftco-animate">
            <div class="media block-6 services p-3 py-4 d-block text-center">
              ...
              <div class="media-body px-3">
                <h3 class="heading">Tablón de anuncios</h3>
                <p>Incluso el todopoderoso Señalamiento no tiene control sobre los textos ciegos, es un texto casi poco ortográfico.</p>
              </div>
            </div>      
          </div>
          <div class="col-md-4 d-flex align-self-stretch ftco-animate">
            <div class="media block-6 services p-3 py-4 d-block text-center">
              ...
              <div class="media-body px-3">
                <h3 class="heading">Nuestra Biblioteca</h3>
                <p>Incluso el todopoderoso Señalamiento no tiene control sobre los textos ciegos, es un texto casi poco ortográfico.</p>
              </div>
            </div>    
          </div>
    	...
    	<div class="container">
    		<div class="row d-md-flex justify-content-center">
    			<div class="col-md-9 about-video text-center">
    				<h2 class="ftco-animate">Cetpro Peru Suizo es una de las principales  Cetpros de todo el Perú</h2>
    				<div class="video d-flex justify-content-center">
    					<a href="https://www.youtube.com/watch?v=4J-lLDp4OXs" class="button popup-vimeo d-flex justify-content-center align-items-center"><span class="ion-ios-play"></span></a>
    				</div>
    			</div>
    		</div>
    	</div>
    	...
    	<div class="container">
    		<div class="row justify-content-center">
              ...
              <?php
                                            ...
                                            //$raul= "SELECT * FROM suizo";
//$result = mysqli_query($conn,$raul);
    			...
    			<div class="col-md-12">
    				<div class="d-flex align-items-center">
			    		<div class="free-trial ftco-animate">
			    			<h3>Pruebe nuestro curso de prueba gratuito</h3>
			    			<p>Incluso el todopoderoso Señalando no tiene control sobre los textos ciegos, es una vida casi poco ortográfica</p>
			    		</div>
			    		<div class="btn-join ftco-animate">
			    			<p><a href="#" class="btn btn-primary py-3 px-4">Únete Ahora!</a></p>
			    		</div>
			    	</div>
    			</div>
    		</div>
    ...
    <section class="ftco-section">
    	<div class="container">
          ...
          <div class="col-md-7 heading-section ftco-animate text-center">
            <h2 class="mb-4">Nuestros Cursos</h2>
          </div>
        </div>
    		<div class="row">
    			<div class="col-md-4 d-flex ftco-animate">
    				<div class="course align-self-stretch">
    					...
    					<div class="text p-4">
    						<p class="category"><span>Ingles</span></p>
    						<h3 class="mb-3"><a href="#">Inglés Basico</a></h3>
    						<p>Incluso el todopoderoso Señalar no tiene control sobre los textos ciegos, es una vida casi poco ortográfica Un día, sin embargo, una pequeña línea de texto ciego con el nombre</p>
    						<p><a href="#" class="btn btn-primary">Inscribete Ahora!</a></p>
    					</div>
    				</div>
    			</div>
    			<div class="col-md-4 d-flex ftco-animate">
    				<div class="course align-self-stretch">
    					...
    					<div class="text p-4">
    						<p class="category"><span>Ingles</span></p>
    						<h3 class="mb-3"><a href="#">    						<h3 class="mb-3"><a href="#">Inglés Basico</a></h3>
</a></h3>
    						<p>Incluso el todopoderoso Señalar no tiene control sobre los textos ciegos, es una vida casi poco ortográfica Un día, sin embargo, una pequeña línea de texto ciego con el nombre</p>
    						<p><a href="#" class="btn btn-primary">Inscribete Ahora!</a></p>
    					</div>
