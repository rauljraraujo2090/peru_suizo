...
<select class="form-select" name="elmodulos" aria-label="Default select example">

  <option selected>-----Seleccione-----</option>
  <option value="MANTENIMIENTO">MANTENIMIENTO</option>
  <option value="OPERADOR DE COMPUTADORAS">OPERADOR DE COMPUTADORAS</option>
...
$query=mysqli_query($conn,"SELECT * FROM suizo");
